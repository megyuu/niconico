 ...
 */
package com.niconico.app.web.base.login;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalEntity;
import org.dbflute.optional.OptionalThing;
import com.niconico.app.web.signin.SigninAction;
import com.niconico.dbflute.cbean.MemberCB;
import com.niconico.dbflute.exbhv.MemberBhv;
import com.niconico.dbflute.exbhv.MemberLoginBhv;
import com.niconico.dbflute.exentity.Member;
import com.niconico.dbflute.exentity.MemberLogin;
import com.niconico.mylasta.action.NiconicoUserBean;
import com.niconico.mylasta.direction.NiconicoConfig;
 ...
 * @author jflute
 */
public class NiconicoLoginAssist extends TypicalLoginAssist<Integer, NiconicoUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected NiconicoUserBean createUserBean(Member userEntity) {
        return new NiconicoUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(config.getCookieRememberMeNiconicoKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, NiconicoUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<NiconicoUserBean> getUserBeanType() {
        return NiconicoUserBean.class;
    }
