 ...
 * @author jflute
 */
public class NiconicoApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
    ...
    public static class TooSimpleFailureResult {
        ...
        public final String notice = "[Attension] tentative JSON so you should change it: " + NiconicoApiFailureHook.class;
        @Required
