...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberAddressId = cci("MEMBER_ADDRESS_ID", "MEMBER_ADDRESS_ID", null, "会員住所ID", Integer.class, "memberAddressId", null, true, true, true, "INTEGER", 10, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_58EA1790_DB4A_4C56_8E39_E16DD8447F68", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.niconico.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "com.niconico.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "com.niconico.dbflute.exbhv.MemberAddressBhv"; }
