...
import com.niconico.app.web.mypage.MypageAction;
 ...
 * @author jflute
 */
public class SigninAction extends NiconicoBaseAction {
    ...
    private void moreValidate(SigninForm form, NiconicoMessages messages) {
