 ...
 */
package com.niconico.app.web.base;

import javax.annotation.Resource;

import org.dbflute.optional.OptionalThing;
import com.niconico.app.logic.context.AccessContextLogic;
import com.niconico.app.web.base.login.NiconicoLoginAssist;
import com.niconico.app.web.base.view.HeaderBean;
import com.niconico.mylasta.action.NiconicoHtmlPath;
import com.niconico.mylasta.action.NiconicoMessages;
 ...
 * @author jflute
 */
public abstract class NiconicoBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<NiconicoMessages>, NiconicoHtmlPath {
    ...
    @Resource
    private NiconicoLoginAssist loginAssist;
    ...
    @Override
    protected OptionalThing<NiconicoUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<NiconicoMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public NiconicoMessages createMessages() { // application may call
        return new NiconicoMessages(); // overriding to change return type to concrete-class
    }
