 ...
 */
package com.niconico.dbflute.bsentity.dbmeta;
...
import com.niconico.dbflute.allcommon.*;
import com.niconico.dbflute.exentity.*;
...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberFollowingId = cci("MEMBER_FOLLOWING_ID", "MEMBER_FOLLOWING_ID", null, "会員フォローイングID", Long.class, "memberFollowingId", null, true, true, true, "BIGINT", 19, 0, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_AC791FC6_33A7_40FE_8D07_E5EAD6953574", false, null, null, null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "com.niconico.dbflute.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "com.niconico.dbflute.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "com.niconico.dbflute.exbhv.MemberFollowingBhv"; }
