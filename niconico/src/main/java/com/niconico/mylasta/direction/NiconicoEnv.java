...
public interface NiconicoEnv {
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/niconico */
    ...
    /** The key of the configuration. e.g. returnpath@niconico.com */
    String MAIL_RETURN_PATH = "mail.return.path";

    /** The key of the configuration. e.g. niconico-support@annie.example.com */
    String MAIL_ADDRESS_SUPPORT = "mail.address.support";

    /** The key of the configuration. e.g. org.h2.Driver */
    String JDBC_DRIVER = "jdbc.driver";

    /** The key of the configuration. e.g. jdbc:h2:file:$classes(com.niconico.dbflute.allcommon.DBCurrent.class)/../../etc/testdb/niconicodb */
    String JDBC_URL = "jdbc.url";

    /** The key of the configuration. e.g. niconicodb */
    ...
    /** The key of the configuration. e.g. localhost:8090/niconico */
     ...
     * The value is, e.g. /tmp/lastaflute/niconico <br>
     ...
     * The value is, e.g. returnpath@niconico.com <br>
     ...
     * The value is, e.g. niconico-support@annie.example.com <br>
     * comment: Mail Address for Niconico Support
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
     ...
     * The value is, e.g. jdbc:h2:file:$classes(com.niconico.dbflute.allcommon.DBCurrent.class)/../../etc/testdb/niconicodb <br>
     ...
     * The value is, e.g. niconicodb <br>
     ...
     * The value is, e.g. localhost:8090/niconico <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends ObjectiveConfig implements NiconicoEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getLastaDiSmartDeployMode() {
            return get(NiconicoEnv.lasta_di_SMART_DEPLOY_MODE);
        }

        public String getDevelopmentHere() {
            return get(NiconicoEnv.DEVELOPMENT_HERE);
        }

        public boolean isDevelopmentHere() {
            return is(NiconicoEnv.DEVELOPMENT_HERE);
        }

        public String getEnvironmentTitle() {
            return get(NiconicoEnv.ENVIRONMENT_TITLE);
        }

        public String getFrameworkDebug() {
            return get(NiconicoEnv.FRAMEWORK_DEBUG);
        }

        public boolean isFrameworkDebug() {
            return is(NiconicoEnv.FRAMEWORK_DEBUG);
        }

        public String getTimeAdjustTimeMillis() {
            return get(NiconicoEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(NiconicoEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public String getLogLevel() {
            return get(NiconicoEnv.LOG_LEVEL);
        }

        public String getLogConsoleLevel() {
            return get(NiconicoEnv.LOG_CONSOLE_LEVEL);
        }

        public String getLogFileBasedir() {
            return get(NiconicoEnv.LOG_FILE_BASEDIR);
        }

        public String getMailSendMock() {
            return get(NiconicoEnv.MAIL_SEND_MOCK);
        }

        public boolean isMailSendMock() {
            return is(NiconicoEnv.MAIL_SEND_MOCK);
        }

        public String getMailSmtpServerMainHostAndPort() {
            return get(NiconicoEnv.MAIL_SMTP_SERVER_MAIN_HOST_AND_PORT);
        }

        public String getMailSubjectTestPrefix() {
            return get(NiconicoEnv.MAIL_SUBJECT_TEST_PREFIX);
        }

        public String getMailReturnPath() {
            return get(NiconicoEnv.MAIL_RETURN_PATH);
        }

        public String getMailAddressSupport() {
            return get(NiconicoEnv.MAIL_ADDRESS_SUPPORT);
        }

        public String getJdbcDriver() {
            return get(NiconicoEnv.JDBC_DRIVER);
        }

        public String getJdbcUrl() {
            return get(NiconicoEnv.JDBC_URL);
        }

        public String getJdbcUser() {
            return get(NiconicoEnv.JDBC_USER);
        }

        public String getJdbcPassword() {
            return get(NiconicoEnv.JDBC_PASSWORD);
        }

        public String getJdbcConnectionPoolingSize() {
            return get(NiconicoEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(NiconicoEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public String getServerDomain() {
            return get(NiconicoEnv.SERVER_DOMAIN);
        }
    }
}
