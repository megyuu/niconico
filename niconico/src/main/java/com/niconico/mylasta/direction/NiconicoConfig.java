...
import com.niconico.mylasta.direction.NiconicoEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface NiconicoConfig extends NiconicoEnv {

    /** The key of the configuration. e.g. niconico */
    ...
    String COOKIE_REMEMBER_ME_HARBOR_KEY = "cookie.remember.me.niconico.key";
    ...
    /**
     * Get the value for the key 'cookie.remember.me.niconico.key'. <br>
     * The value is, e.g. HRB <br>
     * comment: The cookie key of remember-me for Niconico #change_it_first
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeNiconicoKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends NiconicoEnv.SimpleImpl implements NiconicoConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(NiconicoConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(NiconicoConfig.DOMAIN_TITLE);
        }

        public String getCookieDefaultPath() {
            return get(NiconicoConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(NiconicoConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(NiconicoConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(NiconicoConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(NiconicoConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeNiconicoKey() {
            return get(NiconicoConfig.COOKIE_REMEMBER_ME_HARBOR_KEY);
        }
    }
}
