 ...
 * @author jflute
 */
public class NiconicoSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public NiconicoSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
